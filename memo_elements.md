...
|Elements name|Attributes|Description|Reference|
|:-----:|:-----:|:-----:|:-----:|
...
|abbr|-@type (values: siglum, hand) -@rend(value: check)|Abbreviation. Contains an abbreviation of any sort. In the context of the critical edition, it is used to provide the expected rendering display of any witnesses sigla.|§2.1.3; §7.2.3; §8.6.5; §9.3.2.3|
...
|body||The main body of the text. This element is required in any TEI conformant document.|§3.1; §9.1.2.1; §9.2.2.1; §9.3.2.1|
...
|resp||Responsibility. Contains a phrase describing the type of responsibility, e.g. transcription, conversion, proof-reading.|§2.1.1.2|
|respStmt||Statement of responsibility. Particularly important when listing the contributors to an edition.|§2.1.1.2|
